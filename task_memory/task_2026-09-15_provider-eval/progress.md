...
- Added latest-result persistence to `/data/ycfeng/codex-iq.md`. The artifact records the generation time, model, effort, provider selection, test count, timeout, the same readable result table, and the summary.
